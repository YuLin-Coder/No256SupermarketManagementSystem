...
<div class="page-content clearfix">
    <div id="Member_Ratings">
      ...
      <form method="post" action="fFtypeListQuery.do" >
    <div class="search_style">
      <!-- <ul class="search_content clearfix">
       <li>
        <li><label class="l_f">分类名</label><input name="uname" type="text"  class="text_add" placeholder="请输入搜索分类名"  style=" width:400px"/></li>
     ...
     <div class="border clearfix">
       <span class="l_f">
       <a href="type_add.jsp" id="member_add" class="btn btn-warning"><i class="icon-plus"></i>添加</a>
       </span>
     </div>
	...
	<tbody>
		...
		<tr>
          ...
          <td>${n.name }</td>
          <td class="td-manage">
          <a title="编辑" onclick="member_edit1('550')" href="doUpdateFtype.do?id=${n.id }"  class="btn btn-xs btn-info" ><i class="icon-edit bigger-120">修改</i></a>
          <a title="删除" href="deleteFtype.do?id=${n.id }"  onclick="return del(1,1,1)" class="btn btn-xs btn-warning" ><i class="icon-trash  bigger-120">删除</i></a>
          </td>
        </tr>
        </c:forEach>
      <tr>
