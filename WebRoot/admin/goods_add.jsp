  ...
  <div class="body-content">
    <form method="post" class="form-x" action="addGoods.do" enctype="multipart/form-data">  
      ...
      <div class="form-group">
        ...
        <div class="field">
          <input type="text" class="input w50" size="18" name="kcnum"  value="0" data-validate="required:请输入库存量" readonly="readonly" />
          <div class="tips"></div>
        </div>
      </div>
      <div class="form-group">
        ...
        <div class="field">
          <input type="number" class="input w50" size="18" name="minnum"  value="1" required="required" data-validate="required:请输入预警库存"  />
          <div class="tips"></div>
        </div>
      </div>
     <div class="form-group">
      ...
      <div class="form-group">
       ...
       <div class="form-group">
        ...
        <div class="field">
          <input type="text" class="input w50" size="18" name="hprice" data-validate="required:请输入进货价格"  value="${jz.hprice }"/>
          <div class="tips"></div>
        </div>
      </div>
       <div class="form-group">
        ...
        <div class="field">
          <input type="text" class="input w50" size="18" name="etime" onclick="WdatePicker();" />
          <div class="tips"></div>
        </div>
      </div>
       <div class="form-group">
        ...
        <div class="field">
          <input type="text" class="input w50" size="18" name="cname"  />
          <div class="tips"></div>
        </div>
      </div>
