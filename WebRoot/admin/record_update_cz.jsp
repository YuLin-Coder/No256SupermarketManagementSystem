...
<div class="panel admin-panel">
  ...
  <div class="body-content">
    <form method="post" class="form-x" action="updateRecord_cz.do" >  
      <div class="form-group">
        <div class="label">
          <label>卡号：</label>
        </div>
        <div class="field">
          <input type="text" class="input w50" size="18" value="${user.idcard }" readonly="readonly" />
      ...
      <div class="form-group">
        ...
        <div class="field">
          <input type="text" class="input w50" size="18" name="price" value="${jz.price }"  data-validate="required:请输入充值金额" />
          <div class="tips"></div>
        </div>
      </div>
