...
<div class="page-content clearfix">
    <div id="Member_Ratings">
      ...
      <form method="post" action="userList_hyQuery.do" >
	...
	<tbody>
		...
		<tr>
          ...
          <td>${u.money}</td>
          <td class="td-manage">
          <a title="充值" href="doAddRecord_cz.do?id=${u.id }"  class="btn btn-xs btn-info" ><i class="icon-edit bigger-120">充值</i></a>
          <a title="编辑" href="doUpdateUser_hy.do?id=${u.id }"  class="btn btn-xs btn-info" ><i class="icon-edit bigger-120">修改</i></a>
      ...
      <tr>
		...
		<td colspan="8"> <c:if test="${page.page>1}">
              <a href="userList_hy.do?page=1" >首页</a>
             <a href="userList_hy.do?page=${page.page-1 }"> 上一页</a> 
             </c:if>
    	     <c:if test="${page.page<page.totalPage}">
			<a href="userList_hy.do?page=${page.page+1 }">下一页</a>
			<a href="userList_hy.do?page=${page.totalPage }">末页</a>
		    </c:if> 
		</td>
	</c:if>
	<c:if test="${sessionScope.p==2 }">
	<td colspan="8"> <c:if test="${page.page>1}">
    <a href="userList_hyQuery.do?page=1" >首页</a>
    <a href="userList_hyQuery.do?page=${page.page-1 }"> 上一页</a> 
    </c:if>
    	<c:if test="${page.page<page.totalPage}">
			<a href="userList_hyQuery.do?page=${page.page+1 }">下一页</a>
			<a href="userList_hyQuery.do?page=${page.totalPage }">末页</a>
		</c:if> 
		</td>
		</c:if>
		</tr>
