...
<div class="page-content clearfix">
    <div id="Member_Ratings">
      ...
      <form method="post" action="recordList_search.do" >
	...
	<tbody>
		...
		<tr>
          ...
          <td>${jz.etime }</td>
          <td class="td-manage">
          <a title="编辑" href="doUpdateRecord.do?id=${jz.id }"  class="btn btn-xs btn-info" ><i class="icon-edit bigger-120">修改</i></a>
          <a title="删除" href="deleteRecord.do?id=${jz.id }"  onclick="return del(1,1,1)" class="btn btn-xs btn-warning" ><i class="icon-trash  bigger-120">删除</i></a>
          </td>
        </tr>
        </c:forEach>
      <tr>
	...
	<td colspan="8"> <c:if test="${page.page>1}">
    <a href="recordList_search.do?page=1" >首页</a>
    <a href="recordList_search.do?page=${page.page-1 }"> 上一页</a> 
    </c:if>
    	<c:if test="${page.page<page.totalPage}">
			<a href="recordList_search.do?page=${page.page+1 }">下一页</a>
			<a href="recordList_search.do?page=${page.totalPage }">末页</a>
		</c:if> 
		</td>
		</c:if>
		</tr>
