...
<%-- <div id="scrollsidebar" class="left_Treeview">
   ...
   <div class="type_title">更新用户信息</div>
   <form method="post" class="form-x" action="updateUser_hy.do" class="form form-horizontal" id="form-article-add">  
     <div class="clearfix cl">
         <label class="form-label col-2"><span class="c-red">*</span>真实姓名：</label>
		 <div class="formControls col-9">
		  <input type="text" class="input-text"  name="tname" value="${user.tname }" />
		...
		<%-- <div class="clearfix cl">
		 ...
		 <div class="formControls col-9">
		  <input type="text" class="input-text"  name="user.idnumber" value="<s:property value="user.idnumber"/>" />
		 </div>
		</div> --%>
		<div class="clearfix cl">
         <label class="form-label col-2"><span class="c-red">*</span>账号：</label>
		 <div class="formControls col-9">
		  <input type="text" class="input-text" name="uname" value="${user.uname }"  readonly="readonly" />
		 </div>
		</div>
		<div class="clearfix cl">
		...
		<div class="clearfix cl">
		 ...
		 <div class="formControls col-9">
		  <input type="text" class="input-text"  name="tel" value="${user.tel }" />
		 </div>
		</div>
		<div class="clearfix cl">
         <label class="form-label col-2"><span class="c-red">*</span>密码：</label>
		 <div class="formControls col-9">
		  <input type="password" class="input-text"  name="pwd" value="${user.pwd }" />
		 </div>
		</div>
		<div class="clearfix cl">
         <label class="form-label col-2"><span class="c-red">*</span>性别：</label>
		 <div class="formControls col-9">
		  <input type="text" class="input-text"  name="sex" value="${user.sex }" />
		 </div>
		</div>
     <div class="clearfix cl">
