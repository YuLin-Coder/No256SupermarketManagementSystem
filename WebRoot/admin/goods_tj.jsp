...
<div class="page-content clearfix">
    <div id="Member_Ratings">
      ...
      <form method="post" action="vaguegoods_tj.do" >
	...
	<tbody>
      ...
      <tr>
		...
		<td colspan="15"> <c:if test="${page.page>1}">
              <a href="goods_tj.do?page=1" >首页</a>
             <a href="goods_tj.do?page=${page.page-1 }"> 上一页</a> 
             </c:if>
    	     <c:if test="${page.page<page.totalPage}">
			<a href="goods_tj.do?page=${page.page+1 }">下一页</a>
			<a href="goods_tj.do?page=${page.totalPage }">末页</a>
		    </c:if> 
		</td>
	</c:if>
	<c:if test="${sessionScope.p==2 }">
	<td colspan="15"> <c:if test="${page.page>1}">
    <a href="vaguegoods_tj.do?page=1" >首页</a>
    <a href="vaguegoods_tj.do?page=${page.page-1 }"> 上一页</a> 
    </c:if>
    	<c:if test="${page.page<page.totalPage}">
			<a href="vaguegoods_tj.do?page=${page.page+1 }">下一页</a>
			<a href="vaguegoods_tj.do?page=${page.totalPage }">末页</a>
		</c:if> 
		</td>
		</c:if>
		</tr>
