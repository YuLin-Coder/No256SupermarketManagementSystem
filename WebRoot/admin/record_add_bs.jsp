...
<div class="panel admin-panel">
  ...
  <div class="body-content">
    <form method="post" class="form-x" action="addRecord_bs.do" >  
     ...
     <%--  <div class="form-group">
      ...
      <div class="form-group">
        ...
        <div class="field">
          <input type="number" class="input w50" size="18" name="snum" min="0" max="${goods.kcnum }" required="required"  value="0" data-validate="required:请输入" />
          <div class="tips"></div>
        </div>
      </div>
         <div class="form-group">
        ...
        <div class="field">
          <input type="text" class="input w50" size="18" name="cname"  value="${goods.cname }"  />
          <div class="tips"></div>
        </div>
      </div>
      <%--  <div class="form-group">
