...
<div class="page-content clearfix">
    ...
    <div class="search_style">
      <ul class="search_content clearfix">
       <li>
        <li><label class="l_f">订单名</label><input name="uname" type="text"  class="text_add" placeholder="请输入搜索订单名"  style=" width:400px"/></li>
     ...
     <div class="border clearfix">
       <!-- <span class="l_f">
       <a href="user_add.jsp" id="member_add" class="btn btn-warning"><i class="icon-plus"></i>添加订单</a>
       </span> -->
     </div>
	...
	<tbody>
		...
		<tr>
          ...
          <a  href="deleteForder.do?id=${o.kid }" class="btn btn-xs btn-warning"><span class="icon-edit"></span> 退货</a>
          </c:if>
          <a title="查看详情"  href="showOrderDetail.do?id=${o.kid }"  class="btn btn-xs btn-info" ><i class="icon-edit bigger-120">查看详情</i></a>
          </td>
        </tr>
        </c:forEach>
        <tr>
...
<div class="add_menber" id="add_menber_style" style="display:none">
    ...
    <ul class=" page-content">
     <li><label class="label_name">用&nbsp;&nbsp;户 &nbsp;名：</label><span class="add_name"><input  name="user.uname" id="uname" placeholder="请输入订单名" type="text"  class="text_add" onblur="checkName()" /></span><div id="checku" class="prompt r_f"></div></li>
